...
@section('content')
    ...
    <div class="card-body page-error">
        <div class="row">
           	<div class="col-md-12">
               	<form name="editCategoryForm" id="editCategoryForm" action="{{ route('categories.update', $category->id) }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" placeholder="Title" name="title" id="title" class="form-control" value="{{ $category->title }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <textarea placeholder="Description" name="description" id="description" class="form-control tinymceEditor">{{ $category->description }}</textarea>
                            </div>
                        </div>
                    </div>
                    <!--<div class="row">
